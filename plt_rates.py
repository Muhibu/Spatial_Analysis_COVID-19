...
# ===============Calculate rates of changes for every day of every country =============

#create dfr ( for dataframerates) from df (hint rate=day2/day1)
dfp=dfr[['France','Italy','Spain','Tanzania','Sweden','Portugal','Poland','Brazil']] # select column with specific names of countries and store it into dfp dataframe to plot
dfp.plot()